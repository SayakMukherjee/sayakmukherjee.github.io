...
I am Sayak Mukherjee (সায়ক মুখার্জী), a doctoral researcher at the Cognitive Affective Technology (CAT) Lab at TU Delft working under the guidance of [Bernd Dudzik](https://www.tudelft.nl/en/staff/b.j.w.dudzik/?cHash=14faedd04b6a16627463d4d97027a904) and [Tom Viering](https://www.tomviering.nl/). My research focuses on developing data-efficient, context-sensitive, and privacy-preserving multimodal AI systems for automatic affect prediction—paving the way for Artificial Empathic Agents. Current deep learning approaches struggle with data efficiency and in capturing situational, cultural, and personal contextual subtleties, limiting their real-world effectiveness. My work aims to bridges insights from cognitive psychology and (probabilistic) machine learning to model human cognitive-affective processes more effectively, thereby addressing these key challenges. 
